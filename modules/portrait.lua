...
function Portrait:Update(frame, event)
	...
	if( type == "class" ) then
		...
		if( classToken ) then
			...
			frame.portrait:SetTexCoord(CLASS_ICON_TCOORDS[classToken][1]+0.02, CLASS_ICON_TCOORDS[classToken][2]-0.02, CLASS_ICON_TCOORDS[classToken][3]+0.02, CLASS_ICON_TCOORDS[classToken][4]-0.02)
		else
